        ...
        <div className="m-auto lg:max-w-6xl py-6 px-2">
          <div className="grid grid-cols-2 w-full mb-12 justify-center items-center">
            ...
            <div className="flex flex-row justify-end lg:block">
              <img
                className="p-6 size-48 lg:px-36 lg:size-full"
                src={circlePicture}
              ></img>
            </div>
          ...
          <p className="px-6 py-2 leading-relaxed dark:text-slate-200 text-slate-900">
            As of last update, I have been programming for just a little bit
            more than 3 years now.
          </p>
          <p className="px-6 py-2 leading-relaxed dark:text-slate-200 text-slate-900">
            I believe that it's important to be a generalist. I have luckily
            been able to touch almost everywhere in the stack, from the
            frontend, backend, database, networking, and pipelines.
          </p>
          ...
          <p className="font-mono bg-slate-100 dark:bg-zinc-900 my-12 mx-6 p-6 leading-relaxed rounded-lg">
            ...
            <br></br>
            &nbsp;&nbsp;&nbsp;<span className="text-red-700">- </span>JavaScript
            / TypeScript
            <br></br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br></br>
            &nbsp;&nbsp;&nbsp;<span className="text-red-700">- </span>Azure /
            Azure Devops
            <br></br>
            &nbsp;&nbsp;&nbsp;<span className="text-red-700">- </span>AWS /
            Cloudformation
          </p>
